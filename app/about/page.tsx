    ...
    <div className="grow md:flex space-y-8 md:space-y-0 md:space-x-8 pt-12 md:pt-16 pb-16 md:pb-20">
      ...
      <div className="grow">
        <div className="max-w-[700px]">
          ...
          <section>
            { /* Page title */}
            <h1 className="h1 font-aspekta mb-5">Hi. I'm <span className="inline-flex relative text-custom-yellow-500 before:absolute before:inset-0 before:bg-custom-yellow-200 dark:before:bg-custom-yellow-500 before:opacity-30 before:-z-10 before:-rotate-2 before:translate-y-1/4">Huzaifa</span> Mustafa 🤟</h1>
            ...
            <div className="text-slate-500 dark:text-slate-400 space-y-8">
              <div className="space-y-4">
                ...
                <p>
                  Since 2014, I've been active in the IT world, doing everything from building full-stack systems to leading teams, managing projects, and teaching others. But what really gets me excited is Shopware. As a certified Advanced Shopware Developer, I'm a whizz at making Shopware plugins. Imagine your business with just the right Shopware solutions, custom-built to fit like a glove. That's what I'm here to help you with. I want to be your go-to guy for navigating the world of digital transformation, using the power of Shopware. Ready to see what Shopware can do for your business? Get in touch, and let's start the adventure together.
                </p>
              </div>
              <div className="space-y-4">
                <h2 className="h3 font-aspekta text-slate-800 dark:text-slate-100">Career</h2>
                <p>
                  In my role as a Senior Software Engineer for Google Chrome, I am responsible for developing and maintaining the <a className="font-medium text-custom-yellow-500 hover:underline" href="#0">Chrome Web Browser</a>.
                </p>
                <p>
                  My work involves developing and testing new features, optimizing performance and security, and ensuring the browser works for users around the world. I also work closely with other Google teams ensure Chrome is well-integrated with other <a className="font-medium text-custom-yellow-500 hover:underline" href="#0">Google</a> products and services.
                </p>
                <p>
              ...
              <div className="space-y-4">
                ...
                <p>
                  I'm excited to connect with others via <a className="font-medium text-custom-yellow-500 hover:underline" href="#0">email</a> and <a className="font-medium text-custom-yellow-500 hover:underline" href="#0">Twitter</a> to chat about projects and ideas. Currently, I'm not taking on freelance projects, but I am open to hearing about potential opportunities, discussing them with you and then potentially collaborating if it's a good fit.
                </p>
              </div>
            </div>
          </section>
